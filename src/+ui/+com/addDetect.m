...
uicontrol(bActBt,'String','Run','Tag','wkflActRun','Callback',{@ui.detect.actRun,f});
bAct.Heights = [80,20];
...
uicontrol(bPhaseBt,'String','Run','Tag','wkflPhaseRun','Callback',{@ui.detect.phaseRun,f});
...
uicontrol(bEvtBt,'String','Run','Tag','wkflEvtRun','Callback',{@ui.detect.evtRun,f});
bEvt.Heights = [100,20];
